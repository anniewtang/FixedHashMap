/**
 * Initially used junit testing & assertEquals to properly unit test,
 * but since we can't use external libaries, I decided to change all of it to print statements!
 */
...
public class TestHM {
    public static FixedHashMap testInt= new FixedHashMap(3);
    public static FixedHashMap testStr = new FixedHashMap(10);
